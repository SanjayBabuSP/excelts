...
## [6.0.0-beta.5](https://github.com/cjnoname/excelts/compare/excelts-v6.0.0-beta.4...excelts-v6.0.0-beta.5) (2026-03-13)
...
* Add cell format parser and improve browser compatibility ([975b508](https://github.com/cjnoname/excelts/commit/975b508c5de1fe00d5df2e7fe54902a0696c78c2))
...
* **archive:** Add browser Worker Pool for off-main-thread compression ([f0da9fc](https://github.com/cjnoname/excelts/commit/f0da9fc324e2b5b0e4866a87a974095a196e5b01))
* **archive:** Add deleteDirectory() to ZipEditor ([d80a11f](https://github.com/cjnoname/excelts/commit/d80a11fd87b709fb47bdae7e304b6e11bc9c41d3))
* **archive:** Add full GZIP support for Node.js and browser ([9e125b1](https://github.com/cjnoname/excelts/commit/9e125b159a57736bc842b888c71f069ec71015e0))
* **archive:** Add full streaming support to ArchiveFile ([487f455](https://github.com/cjnoname/excelts/commit/487f455faa89e469dac63b7a0a34a818443fff46))
* **archive:** Add HTTP Range support for remote ZIP reading ([2fd74c6](https://github.com/cjnoname/excelts/commit/2fd74c664d00dd590ad2d6704e19461c81e2cc42))
* **archive:** Add progress + abort operations for zip/unzip ([9557a37](https://github.com/cjnoname/excelts/commit/9557a37fc7207c074c956e598da232f6aaad8010))
* **archive:** Add TAR archive support with unified API ([e2d1e39](https://github.com/cjnoname/excelts/commit/e2d1e3950fcdbf7a8981a26eb08eaaa8f512902d))
* **archive:** Add transform function and concurrency option ([9f11f52](https://github.com/cjnoname/excelts/commit/9f11f523240fa94c11f98a65865d976adedcc3d2))
* **archive:** Add warnings, stream adapters, and IO concurrency ([c6d0bbd](https://github.com/cjnoname/excelts/commit/c6d0bbd19457a3688349cf3da7b42631d2be1b41))
* **archive:** Add ZIP encryption support (ZipCrypto + AES) ([23ac09b](https://github.com/cjnoname/excelts/commit/23ac09b99e76e3f016a607d793adcf26078a627a))
* **archive:** Add zip noSort and ZipParser.childCount ([53c4bf7](https://github.com/cjnoname/excelts/commit/53c4bf7ff202d831e331f4736aea48548cf7dfaf))
* **archive:** Add ZIP64 write support and safe ZIP64 parsing ([ff866e6](https://github.com/cjnoname/excelts/commit/ff866e699d4164d983cc4e312ec56c0b4a188c62))
* **archive:** Add ZipEditor best-effort preserve mode ([e69497d](https://github.com/cjnoname/excelts/commit/e69497d962164a923f8750c772f7535707d8d149))
* **archive:** Add ZipFile class for high-level ZIP operations ([008d89b](https://github.com/cjnoname/excelts/commit/008d89b2fc81ef4851895bd825c39fc095d741ba))
...
* **archive:** Web Streams unzip + true streaming RemoteZipReader ([5fe7051](https://github.com/cjnoname/excelts/commit/5fe70518553fd24b9433670c6fa103492ac48b54))
...
* **csv:** Add append mode for writeFile ([593deae](https://github.com/cjnoname/excelts/commit/593deaeae9f7be476a9aeec6ca6d084841fe3bc2))
* **csv:** Add compatibility features and optimizations ([68ef7ec](https://github.com/cjnoname/excelts/commit/68ef7ec325c2260e70e90d24c4885def1d2fad3a))
* **csv:** Add csv-generate utility for random CSV data generation ([c75d73c](https://github.com/cjnoname/excelts/commit/c75d73c3c22f2db37db616719633df1d3b632608))
* **csv:** Add dynamicTyping, chunk callback, and beforeFirstChunk options ([919f48b](https://github.com/cjnoname/excelts/commit/919f48b12b09a61d5d7c292de09a044eda9cda09))
* **csv:** Add escapeFormulae, fastMode options and refactor streaming ([ac12f41](https://github.com/cjnoname/excelts/commit/ac12f410dd50cdb56cf29b7d75150c49b050884f))
* **csv:** Add field-level quoting control and refactor utilities ([0a82203](https://github.com/cjnoname/excelts/commit/0a82203ff6b06b18eced85e69f29059fa6b8ca08))
* **csv:** Add info/raw and relaxQuotes options ([521e484](https://github.com/cjnoname/excelts/commit/521e484565eea202a4839f2f1a30fd0ef0a82b92))
* **csv:** Add maxRowBytes option for DoS protection ([3245b08](https://github.com/cjnoname/excelts/commit/3245b080d86ffc6a93f4d42c03433768857a49c5))
* **csv:** Add new parsing options and refactor shared utilities ([45a84b0](https://github.com/cjnoname/excelts/commit/45a84b05bc3cf15db6c9e6ec43d19ed6e3715f17))
* **csv:** Add RowHashArray support for formatting ([0c8d432](https://github.com/cjnoname/excelts/commit/0c8d432a3b4357e4a1a003f395ffaa82538e2315))
* **csv:** Add TypeTransformMap for type-based formatting ([2c37345](https://github.com/cjnoname/excelts/commit/2c3734510eeecc44d673291557d78dde3732021e))
...
* **csv:** Add Web Worker pool for browser CSV operations ([e6758e8](https://github.com/cjnoname/excelts/commit/e6758e8761e211db896f2cecf9037d7e7276d5a3))
* **csv:** Enhance escapeFormulae with additional characters for CSV injection prevention ([124d19a](https://github.com/cjnoname/excelts/commit/124d19a8623016e1ca58f4d7c4ac4a86de17d636))
* **csv:** Generate bundled browser worker + centralize CSV types ([7761cc3](https://github.com/cjnoname/excelts/commit/7761cc33beef135bda1ef96cb88503058842cfa6))
...
* **csv:** Unified API with parse/stringify/toBuffer and delimiter auto-detection ([bd9f88e](https://github.com/cjnoname/excelts/commit/bd9f88e2d1eff8c317dad212f6dda5cfe2ad0fe4))
* Enhance stream API with improved typing and error handling ([53cf027](https://github.com/cjnoname/excelts/commit/53cf02751febcf6abf9528b7f10227191370619f))
* Enhance Transform and Writable streams for better backpressure handling and error management ([4773dd8](https://github.com/cjnoname/excelts/commit/4773dd80a4454587666d8341afad4b668498b88c))
* Enhance ZipCrypto security and add CSV error collection ([7a08413](https://github.com/cjnoname/excelts/commit/7a08413f5c367bac724dfe4138ab37152dfe5c2f))
* **errors:** Add comprehensive error system with typed error classes ([ef73f6c](https://github.com/cjnoname/excelts/commit/ef73f6c074457703e016e8de035de2fc5659fa13))
...
* **excel:** Add chart and drawing passthrough preservation ([501d0bd](https://github.com/cjnoname/excelts/commit/501d0bdf89d980034d634fc82d45a6897803d6cc))
...
* **fs:** Add useFs() for custom file system injection ([c94413c](https://github.com/cjnoname/excelts/commit/c94413c700c984f8fbf598e9cc952091ccc9cea1))
...
* **stream:** Add Symbol.hasInstance, static isDisturbed, pause/resume events, _construct/_undestroy, writev, and addListener/removeListener aliases ([8de5efe](https://github.com/cjnoname/excelts/commit/8de5efe7cbff9c54edd3d8498e77397a40e385d4))
* **stream:** Enhance Duplex and Readable implementations for better compatibility and performance ([60badc1](https://github.com/cjnoname/excelts/commit/60badc1a147468500341b0a67c5d32c8ed8489b9))
* **stream:** Enhance stream functionality with new tests, utility functions, and improved options handling ([123ffcf](https://github.com/cjnoname/excelts/commit/123ffcfce0dbbc34b343480d120599fed3fae829))
...
* **types:** Add proper typing for Row, Cell, and related methods ([3b4a4f1](https://github.com/cjnoname/excelts/commit/3b4a4f1f8759391c22ce73b602b647c62ed5a969)), closes [#2](https://github.com/cjnoname/excelts/issues/2)
* **unzip:** Add cross-platform buffer-based ZIP parser ([7621827](https://github.com/cjnoname/excelts/commit/76218273571f1c28e16803be0af787f180a7a7e4))
* V1.1.0 - Major improvements and bug fixes ([52d301f](https://github.com/cjnoname/excelts/commit/52d301f5e2c054f0103b53a7d86b8dd2c87c3029))
...
* **archive:** Stabilize flaky ZipCrypto wrong password test ([75cfc53](https://github.com/cjnoname/excelts/commit/75cfc53bea7dec8f16d0ceec49b04a526859444e))
...
* **archive:** Stabilize streaming unzip and browser parsing ([a148bdf](https://github.com/cjnoname/excelts/commit/a148bdfd7c77af75413a701999db74a6827004ae))
...
* **csv:** Comprehensive audit fixes across parse, format, stream, and worker modules ([c664dd9](https://github.com/cjnoname/excelts/commit/c664dd99ad0c6ecd0ea3555b647c01ef1d6542b7))
* **csv:** Make streaming record offsets character-based ([76d2574](https://github.com/cjnoname/excelts/commit/76d2574ba9ed6d70d81a245f0de7d0f6e35a94c1))
...
* **duplex:** Change Transform import to type-only import ([13efb04](https://github.com/cjnoname/excelts/commit/13efb046b13f551009c3dba4de8fe439510c86ce))
...
* **excel:** Make legacy form controls OOXML-valid ([1af59b7](https://github.com/cjnoname/excelts/commit/1af59b7f0a2305305c4ab9e6a6b9b9975aaa3add))
...
* Handle missing r attribute in row and cell elements ([#2961](https://github.com/cjnoname/excelts/issues/2961)) ([1fe4709](https://github.com/cjnoname/excelts/commit/1fe4709b06bc0da9c90cc2366b0780568400f266))
...
* Ignore dynamicFilter nodes in filterColumn parsing ([#2972](https://github.com/cjnoname/excelts/issues/2972)) ([609fa18](https://github.com/cjnoname/excelts/commit/609fa1866b0c0c61b3b942eb35d2143239e42280))
...
* Improve public API return types and enum types ([c8ca73c](https://github.com/cjnoname/excelts/commit/c8ca73c10da12fbe5c824e502938a4e6ab0e5017))
...
* Move test fixture to tracked directory for CI ([eede864](https://github.com/cjnoname/excelts/commit/eede86496574c76315e40a5a3c9ed1998690b5c6))
...
* Prevent memory overflow when loading files with many definedNames ([#2925](https://github.com/cjnoname/excelts/issues/2925)) ([bd8d041](https://github.com/cjnoname/excelts/commit/bd8d0415525c92e5d6d9b5a6599d1314b0b383a5))
* Prevent string formula results from being converted to date ([#2970](https://github.com/cjnoname/excelts/issues/2970)) ([4750f59](https://github.com/cjnoname/excelts/commit/4750f59c9de6b47f32a5a0ca514bb4181ab8d1a7))
...
* **stream:** Align browser API surface with Node.js and add comprehensive tests ([6693fbb](https://github.com/cjnoname/excelts/commit/6693fbb6f9ba253aa0df427f2763ffae4c36e391))
* **stream:** Align browser Duplex/Transform end() and asyncDispose with Node.js behavior ([b0aa31f](https://github.com/cjnoname/excelts/commit/b0aa31fe7b10fcbc9854802d8f11af680da4f6a1))
* **stream:** Align browser edge-case behaviors with Node.js ([d216cb9](https://github.com/cjnoname/excelts/commit/d216cb9e6c59d21e24158b0d2e8040cd054e7eae))
* **stream:** Align browser pipeline, compose, duplexPair, and Writable with Node.js behavior ([851b37f](https://github.com/cjnoname/excelts/commit/851b37f4cafba97ac0fa85af6943d0c0b518fc64))
* **stream:** Align browser stream behavior with Node.js and add cross-platform test coverage ([3aaa945](https://github.com/cjnoname/excelts/commit/3aaa945bb8b42a562beb643f0b10e10db50ad8d0))
* **stream:** Align browser stream behavior with Node.js and harden internals ([e1220cc](https://github.com/cjnoname/excelts/commit/e1220ccf43515539a63c5343ed7869162195639e))
* **stream:** Align browser stream behavior with Node.js for _read, async iterators, setEncoding, and HWM defaults ([6d4a835](https://github.com/cjnoname/excelts/commit/6d4a83549936215a33d55867aa9ed3c3f418263a))
...
* **stream:** Align browser stream event timing and API behavior with Node.js ([d317bf2](https://github.com/cjnoname/excelts/commit/d317bf2279002c219813e2d31780c78b0c0a2e9b))
* **stream:** Align browser stream parity with Node.js for double-callback, destroyed writes, and shorthand removal ([5073134](https://github.com/cjnoname/excelts/commit/5073134d5ec565101a6047b9d3f393958f99bd7f))
...
* **stream:** Fix browser finished() arg parsing, Writable end() chunk normalization, and Duplex _undestroy() event forwarding ([7624d09](https://github.com/cjnoname/excelts/commit/7624d09d7589b3b4f332f619df7d7e27ba8bb530))
...
* **stream:** Harden browser compose() for Node.js parity ([7dc16e3](https://github.com/cjnoname/excelts/commit/7dc16e33721f0d6d69ff0015718396a69cc7267e))
...
* **stream:** Refactor compose to use constructor options and fix double-event bugs ([2e1b88a](https://github.com/cjnoname/excelts/commit/2e1b88a97450d4c1a4909825764109a20c938bd8))
...
* **stream:** Resolve 12 browser-vs-Node.js behavioral inconsistencies ([388c1c1](https://github.com/cjnoname/excelts/commit/388c1c10dbc7ec85d3b73306558e43a2bcfaa900))
* **stream:** Support hex/base64/base64url/ascii in browser chunk.toString() ([3c86549](https://github.com/cjnoname/excelts/commit/3c86549565b9ea7d95ffdab37b723347324693ff))
* **stream:** Unify Node/browser API behavior and strengthen test quality ([121d824](https://github.com/cjnoname/excelts/commit/121d82460d96e55c79620ea1dcb54b59fb67da38))
...
* **tests:** Update transform and flush methods to use rest parameters for better argument handling ([fb8313a](https://github.com/cjnoname/excelts/commit/fb8313a23734eca39b52f56ce0381f9e8248a97a))
...
* **types:** Restore proper Row typing for eachRow and add JSDoc comments ([45665af](https://github.com/cjnoname/excelts/commit/45665afc2b080f47729ff3a173065403446c8ea2))
...
* Use optional chaining for date1904 property access in XLSX class ([2bfbd90](https://github.com/cjnoname/excelts/commit/2bfbd90fe175b49400829bec1c001b172f33e189))
...
* **xlsx:** Preserve metadata attributes during round-trip ([#41](https://github.com/cjnoname/excelts/issues/41)) ([21d1ef9](https://github.com/cjnoname/excelts/commit/21d1ef95bd44fef2d2ed0dca153e3cebd4756deb))


### Code Refactoring

* **archive, stream:** Improve compression pipeline, browser stream API parity, and binary utils ([0ed6d28](https://github.com/cjnoname/excelts/commit/0ed6d28bb9859a2e1d1779cbdb8da3b8d03aa36e))
* **archive:** Align browser/node implementations ([06888ab](https://github.com/cjnoname/excelts/commit/06888ab139f364104206ebb83b78e142ae8b035a))
* **archive:** Extract shared ZIP output pipeline from ZipArchive and ZipEditor ([8912118](https://github.com/cjnoname/excelts/commit/89121189df2a31210c6bd430904761bc57cbfc48))
* **archive:** Remove redundant createArchive/createReader public API ([e6c4ff5](https://github.com/cjnoname/excelts/commit/e6c4ff516c8e898f9819bf1fc43b867cb8cc28df))
* **archive:** Reorganize module structure for cleaner boundaries ([f5c208a](https://github.com/cjnoname/excelts/commit/f5c208ae0ea4f5aa1b8dee507e60de2c63a8277e))
* **archive:** Reorganize zip/unzip core + add zip edit APIs ([2acf341](https://github.com/cjnoname/excelts/commit/2acf341555477492930bb19007d742d228a9c203))
* **archive:** Reorganize zip/unzip modules and APIs ([e2300f2](https://github.com/cjnoname/excelts/commit/e2300f27f876bea508111d8333a09d8cc74d10f1))
* **archive:** Reorganize zip/unzip modules and APIs ([8b5f4c5](https://github.com/cjnoname/excelts/commit/8b5f4c517d6bad285da7d50e463e70523879213e))
* **archive:** Simplify ZIP entry type system with breaking changes ([ad63dac](https://github.com/cjnoname/excelts/commit/ad63dac4905837e27d4ab6362d8d9b3c8f55e720))
* **archive:** Unify ArchiveFile for ZIP/TAR and reduce duplication ([9b4c5fa](https://github.com/cjnoname/excelts/commit/9b4c5fa5a41c529a85e2614c74e9486cdafdd7a3))
* **archive:** Unify browser compression, worker streaming, and source helpers ([38f6f9b](https://github.com/cjnoname/excelts/commit/38f6f9b55d47053e9ad35ef3f140cbb0a4ec3319))
* **browser:** Extract shared base classes for Node.js and browser builds ([e7c5450](https://github.com/cjnoname/excelts/commit/e7c545005a212d3dc74801e53801747c36bfe06b))
* **cell:** Drop HyperlinkValueData alias ([abcde5e](https://github.com/cjnoname/excelts/commit/abcde5e7b5ec68f16b48905062978a4349ee4cbc))
* **compression:** Rename zlib functions for API consistency ([c29c03a](https://github.com/cjnoname/excelts/commit/c29c03a7a07622ac4eda938121c54d6ab4316020))
* Consolidate ESM specifier check into fix-esm-imports.mjs ([66a7395](https://github.com/cjnoname/excelts/commit/66a7395118838712955dac210af8550115e13c7e))
* Consolidate pivot-table examples and clean up project config ([24b26d7](https://github.com/cjnoname/excelts/commit/24b26d74046736ec5c17a796c146553b3c4f973b))
* Convert scripts from JS/MJS to TypeScript ([375ff37](https://github.com/cjnoname/excelts/commit/375ff37356815232872fff87a04fceb0d811272a))
* **core:** Unify cross-platform modules ([3e4d6c4](https://github.com/cjnoname/excelts/commit/3e4d6c4c6678588c1cab04f2727ce4e0381e7ed6))
* **csv:** Add completeField helper to parseCsv for consistency ([b4845fe](https://github.com/cjnoname/excelts/commit/b4845fe2dbca19490ba458edb0073ff213738bd4))
* **csv:** Clean up module structure and unify API naming ([e3d4bc0](https://github.com/cjnoname/excelts/commit/e3d4bc0ecf0c7418c35574d8b01080982bda024d))
* **csv:** Consolidate parse-engine into parse-core and add lazy worker loading ([efbc5eb](https://github.com/cjnoname/excelts/commit/efbc5eb75043258e02c16b03deb6dbcc83cbf2dd))
* **csv:** Dedupe decimalSeparator number logic ([c3c79fa](https://github.com/cjnoname/excelts/commit/c3c79fa351b2258eb1f68dd4d2fb646f78004fe0))
* **csv:** Extract detection and row utilities into separate modules ([c3dfa40](https://github.com/cjnoname/excelts/commit/c3dfa4020897eee1f311520e734dd17a68ecc38a))
* **csv:** Extract makeTrimField helper and align worker behavior ([5448378](https://github.com/cjnoname/excelts/commit/5448378746b79c6dd07408769511094902dea325))
* **csv:** Modernize CSV module with improved type safety ([a5f922a](https://github.com/cjnoname/excelts/commit/a5f922adf67323e96788b5472182a66956b02c88))
* **csv:** Rename parseCsvStream to parseCsvRows and improve code organization ([a3834d6](https://github.com/cjnoname/excelts/commit/a3834d67da1acb1fa0b32402541d4e68e48cbfeb))
* **csv:** Replace strictColumnHandling with columnMismatch API ([9e8a08f](https://github.com/cjnoname/excelts/commit/9e8a08f922b85a86b241dbdbe7e124e90075ba57))
* **csv:** Restructure module into subdirectories and remove dead code ([603e9ae](https://github.com/cjnoname/excelts/commit/603e9ae5eb86deb8e27ac131e063a8fb12b677f6))
* **csv:** Simplify public API and merge scanner files ([c93a8b4](https://github.com/cjnoname/excelts/commit/c93a8b4bd969b33e79f0ac9abb82aae2a9c9803b))
* **csv:** Unify character parsing and improve fastMode CRLF handling ([fa4fb73](https://github.com/cjnoname/excelts/commit/fa4fb73b3ebb291b570c072b68bd7eac0102daaa))
* **csv:** Unify constants, improve byte counting, support options.transform/validate ([11c0170](https://github.com/cjnoname/excelts/commit/11c0170dd40f44748fcdacbe3fcd91000a6eb081))
* **deps:** Replace uuid package with native crypto.randomUUID() ([a4c33a1](https://github.com/cjnoname/excelts/commit/a4c33a17abf6da96392caac57fe2ff33be6161b6))
* **excel:** Move excel sources under modules and update imports ([5cfe9f3](https://github.com/cjnoname/excelts/commit/5cfe9f350acd5f77abbbe565b335d7a29bdab91d))
* Improve tree-shaking across all modules ([49b2322](https://github.com/cjnoname/excelts/commit/49b232211005a3ab269a8b0ab11b1e6a07675cbc))
* **pivot-table:** Optimize performance and improve type exports ([5063980](https://github.com/cjnoname/excelts/commit/506398096fcbc4eb7ea13d3ea812118242958e42))
* Remove redundant datetime utilities ([4f2c3c6](https://github.com/cjnoname/excelts/commit/4f2c3c61f5acd729c52ec01f214ae1a9c942b8f1))
* Remove redundant datetime utilities ([956aecb](https://github.com/cjnoname/excelts/commit/956aecbc958941e99820c08f8d0c20e8e3e0de31))
* Remove unused type exports ([8822305](https://github.com/cjnoname/excelts/commit/8822305c2e0c87ccd8976fef9437ae8319e55fbe))
* Restructure entry points and add subpath exports for zip, csv, stream ([1905a4b](https://github.com/cjnoname/excelts/commit/1905a4bda6497f9e494613051ad3eaf6f3ec2de8))
* **stream,archive:** Dedupe helpers and optimize buffering ([327fd59](https://github.com/cjnoname/excelts/commit/327fd5967bb1bba4e0bed06cb006ec717961a5a6))
* **stream,archive:** Dedupe helpers and optimize buffering ([1e0a659](https://github.com/cjnoname/excelts/commit/1e0a659692a56bfa3292000463a24a11c847ea19))
* **stream:** Align stream behavior with Node.js for error handling and event emissions ([4d823a0](https://github.com/cjnoname/excelts/commit/4d823a0631406e1ed2aa3bddf21ef6aa5cf19de3))
* **stream:** Improve duplexPair function by using a holder object for stream references ([f33f088](https://github.com/cjnoname/excelts/commit/f33f0888f85d85e2f6feeff6aec2aaf60dfab1dc))
* **stream:** Modularize stream module architecture and deduplicate shared code ([f851804](https://github.com/cjnoname/excelts/commit/f851804ca3f3deeaa7e58989639c78f328aa6209))
* **stream:** Optimize stream composition and error handling for better performance and compatibility with Node.js ([cad6701](https://github.com/cjnoname/excelts/commit/cad67014b64acd06951113ce253531291d343a2b))
* **stream:** Tighten browser/web bridge and Node stream helpers ([73e7552](https://github.com/cjnoname/excelts/commit/73e755227b691dfec0c875332bb5f779221135a6))
* **stream:** Tighten browser/web bridge and Node stream helpers ([b2b57e9](https://github.com/cjnoname/excelts/commit/b2b57e95a19aa094819d630a5112fe18e02c1780))
* **stream:** Unify cross-platform logic and extract shared utilities ([7cdca1a](https://github.com/cjnoname/excelts/commit/7cdca1adaeef7187932a39974f8b0a7487eb633f))
...
* **table:** Use TableStyleProperties indexed type for theme property ([400f6d0](https://github.com/cjnoname/excelts/commit/400f6d0f162ac49a22ec0bdbcc04295f86ff0414))
* **types:** Improve type safety across Row, Cell, Anchor, Column, Range, Image, Table and stream classes ([13d32d8](https://github.com/cjnoname/excelts/commit/13d32d8a9fcef213cb0220df0ac256aca9cf95ef))
* **types:** Improve type safety in stream Reader/Writer classes ([4d33ec6](https://github.com/cjnoname/excelts/commit/4d33ec63d107c0301b38bdb5612d4ea04bebaaae))
* Update AbortError implementation and related tests to use 'cause' instead of 'reason' ([ab21ce9](https://github.com/cjnoname/excelts/commit/ab21ce918bdda31388b9f30da94c2d256b28d9fc))
* **worksheet:** Relax return types for row methods to improve flexibility ([3eb099f](https://github.com/cjnoname/excelts/commit/3eb099f0e4847a3a7d35640af143815375132c44))
* **worksheet:** Simplify row method signatures and comments ([c4c1e36](https://github.com/cjnoname/excelts/commit/c4c1e36924aeb641be28a80250854af89464a024))
* **zip-parser:** Remove unused centralDirSize variable ([a4dd706](https://github.com/cjnoname/excelts/commit/a4dd7067ba021582df69debddf4f34e78932595e))
* **zip:** Centralize attrs/versionMadeBy, add path normalization + richer timestamps ([b4c8ce5](https://github.com/cjnoname/excelts/commit/b4c8ce57d1f43923e82fe5b429b418ccc948cea3))
* **zip:** Replace fflate with native ZIP utilities ([b4ca754](https://github.com/cjnoname/excelts/commit/b4ca75415a0db72583c6ad663c87506966cd9586))
...
* **archive:** Speed up streaming unzip hot path ([64acb02](https://github.com/cjnoname/excelts/commit/64acb02310d7395143467121ddf5d4a9c2781b52))
* **archive:** Speed up ZIP parse & browser (5MB threshold) ([05484d5](https://github.com/cjnoname/excelts/commit/05484d59e78bd3f0bcacc313234e787ea1acffa0))
* **csv:** Add structural performance optimizations (S1-S5) ([19668c8](https://github.com/cjnoname/excelts/commit/19668c8fdab1678911a3c1e2e9d52c01d93a9892))
* **csv:** Optimize parsing with pre-compiled regex and shared utilities ([c3ac575](https://github.com/cjnoname/excelts/commit/c3ac575d97017489abbede32e5ff263057ded5da))
* **csv:** Optimize parsing with unified helpers and reduced allocations ([270b53c](https://github.com/cjnoname/excelts/commit/270b53c6e9fd8eb214053ece0245717b2a4ea087))
...
* Optimize parsing of large data validation ranges ([cfea95a](https://github.com/cjnoname/excelts/commit/cfea95a31708707cf5cfe4306909423505559a50))
* Replace fflate with native zlib for ZIP compression ([f6ff675](https://github.com/cjnoname/excelts/commit/f6ff6754cab37b82b58c5b3032cb4dbe228d9381)), closes [#2941](https://github.com/cjnoname/excelts/issues/2941)
