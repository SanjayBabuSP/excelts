...
import { Zip, ZipDeflate } from "../modules/archive/streaming-zip";
...
import type { Writable } from "../modules/stream";
import { Writeable, stringToUint8Array } from "../modules/stream";
import {
  mediaPath,
  OOXML_PATHS,
  OOXML_REL_TARGETS,
