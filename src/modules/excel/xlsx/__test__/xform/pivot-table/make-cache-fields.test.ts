...
describe("makeCacheFields", () => {
  describe("field categorization", () => {
    ...
    it("should create numeric sharedItems when field is both row and value (Issue #15)", async () => {
      const workbook = new Workbook();
      const worksheet = workbook.addWorksheet();
  ...
  describe("pivotField attributes", () => {
    it("should set dataField=1 when field is both row and value (Issue #15)", async () => {
      const workbook = new Workbook();
      const worksheet = workbook.addWorksheet();
