...
import type * as NodeStreams from "../../modules/stream/streams";
import type * as BrowserStreams from "../../modules/stream/streams.browser";

import type {
  FinishedOptions as NodeFinishedOptions,
  PipelineOptions as NodePipelineOptions
} from "../../modules/stream/streams";
import type {
  FinishedOptions as BrowserFinishedOptions,
  PipelineOptions as BrowserPipelineOptions
} from "../../modules/stream/streams.browser";

import type * as NodeRuntimeModule from "../../modules/stream/streams";
import type * as BrowserRuntimeModule from "../../modules/stream/streams.browser";
import type {
  ICollector,
  IDuplex,
  IReadable,
